...
public final class VictorSPXSteerControllerFactoryBuilder {
    ...
    public VictorSPXSteerControllerFactoryBuilder withPidConstants(double proportional, double integral, double derivative) {
    ...
    public VictorSPXSteerControllerFactoryBuilder withMotionMagic(double velocityConstant, double accelerationConstant, double staticConstant) {
    ...
    public VictorSPXSteerControllerFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public VictorSPXSteerControllerFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    private class FactoryImplementation<T> implements SteerControllerFactory<ControllerImplementation, SteerConfiguration<T>> {
        ...
        public ControllerImplementation create(SteerConfiguration<T> steerConfiguration, String canbus, MechanicalConfiguration mechConfiguration) {
            ...
            VictorSPXConfiguration motorConfiguration = new VictorSPXConfiguration();
            ...
            if (hasCurrentLimit()) {
                // TODO(ihartwig) figure out how to set the current limit
            ...
            CtreUtils.checkCtreError(
                    ...
                    "Failed to configure VictorSPX status frame period"
            );

            return new ControllerImplementation(motor,
                    sensorPositionCoefficient,
                    sensorVelocityCoefficient,
                    hasMotionMagic() ? VictorSPXControlMode.MotionMagic : VictorSPXControlMode.Position,
                    absoluteEncoder);
        }
    }
    ...
    private static class ControllerImplementation implements SteerController {
        ...
        private final VictorSPXControlMode motorControlMode;
        ...
        private ControllerImplementation(WPI_VictorSPX motor,
                                         double motorEncoderPositionCoefficient,
                                         double motorEncoderVelocityCoefficient,
                                         VictorSPXControlMode motorControlMode,
